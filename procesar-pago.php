                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            ...
                            <div class="column small-12 as-search-results-tiles as-search-results-width">
                                ...
                                <p style="text-align: center;font-size: 45px;color: #11b47d;margin-top: 20px;">Pago procesado</p>
                                <br>

                                <?php if ($_POST['payment_status'] == "approved"): ?>
                                <div class="payment-detail center">
                                    <label class="detail-title">Detalle</label>
                                    <ul>
                                    <?php
                                        echo '<li>Operación: ' . $_POST['payment_id'] . '</li>';
                                    ?>
                                    <?php
                                        echo '<li>Nro de orden: ' . $_POST['merchant_order_id'] . '</li>';
                                    ?>
                                    <?php

                                        $url_back = $_POST['back_url'];

                                        $url_back = explode("?", $url_back);
                                        $url_back = explode("&", $url_back[1]);

                                        $payment_type = "";

                                        foreach ($url_back as $url) {
                                            if (strpos($url, 'payment_type') !== false) {
                                                $url = explode("=", $url);
                                                $payment_type = $url[1];
                                            }
                                        }
                                        ...
                                        if ($payment_type == "") {
                                            echo '<li>Medio de pago elegido: no identificado</li>';
                                        } else {
                                            echo '<li>Medio de pago elegido: ' . $payment_types[$payment_type] . '</li>';
                                        }
                                    ?>
                                    <?php
                                        echo '<li>Monto pagado: $' . $_POST['pricex'] . '</li>';
                                    ?>
                                    </ul>
                                </div>
                                <?php endif; ?>
                                <?php if ($_POST['payment_status'] == "failure"): ?>
                                <div class="payment-detail center">
                                    <label class="detail-title">Detalle</label>
                                    <ul>
                                    <?php
                                        echo '<li>Estado: Pago cancelado</li>';
                                    ?>
                                    </ul>
                                </div>
                                <?php endif; ?>
                                <?php if ($_POST['payment_status'] == "pending" || $_POST['payment_status'] == "in_process"): ?>
                                <div class="payment-detail center">
                                    <label class="detail-title">Detalle</label>
                                    <ul>
                                    <?php
                                        echo '<li>Estado: Pago pendiente o en proceso</li>';
                                    ?>
                                    </ul>
                                </div>
                                <?php endif; ?>
